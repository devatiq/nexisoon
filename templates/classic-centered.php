...
$nexisoon_mode_label = isset($nexisoon_modes[$settings['mode']]) ? $nexisoon_modes[$settings['mode']] : esc_html__('Coming Soon', 'nexisoon');
?>
<main class="nexisoon-page" role="main">
	<section class="nexisoon-container" aria-labelledby="nexisoon-heading">
		...
		<?php if ($has_countdown): ?>
			<div class="nexisoon-countdown"
				data-nexisoon-countdown="<?php echo esc_attr($settings['countdown_datetime']); ?>">
		...
		<?php if (!empty($settings['button_enabled']) && !empty($settings['button_url'])): ?>
			<a class="nexisoon-button"
				href="<?php echo esc_url($settings['button_url']); ?>"><?php echo esc_html($settings['button_text']); ?></a>
		<?php endif; ?>

		<?php if ($settings['footer_text']): ?>
			<footer class="nexisoon-footer"><?php echo wp_kses_post(nl2br(esc_html($settings['footer_text']))); ?>
			</footer>
		<?php endif; ?>
	</section>
</main>